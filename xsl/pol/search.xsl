...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/search_style.css?r=1770651171</iaixsl:attribute></link></iaixsl:when>
    <iaixsl:otherwise><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/search_style.css.gzip?r=1770651171</iaixsl:attribute></link></iaixsl:otherwise>
</iaixsl:choose>
...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/search_shop.js?r=1770651171</iaixsl:attribute></script></iaixsl:when>
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/search_shop.js.gzip?r=1770651171</iaixsl:attribute></script></iaixsl:otherwise>
</iaixsl:choose>
...
<!-- (search, 680207d7280f82.95652452.5)-->
              ...
              <iaixsl:otherwise>
                <picture>
                  ...
                  <iaixsl:if test="$var_omnibus != ''">
					...
					<iaixsl:choose>
						<iaixsl:when test="(@product_type != 'product_item' and @product_type != 'product_virtual' and @product_type != 'virtual') or count(sizes/size) != 1">
							<a class="btn --solid --medium add_to_basket__link" tabindex="-1">
								<iaixsl:attribute name="title">Więcej opcji</iaixsl:attribute>
								<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
								Więcej opcji
							</a>
						</iaixsl:when>
						<iaixsl:otherwise>
							<form class="add_to_basket" action="/basketchange.php" type="post">
								<iaixsl:if test="sizes/size/availability/@status = 'disable' or sizes/size/price/@price_net = 0">
									<iaixsl:attribute name="class">add_to_basket --disabled</iaixsl:attribute>
									<iaixsl:attribute name="aria-hidden">true</iaixsl:attribute>
								</iaixsl:if>
								<iaixsl:if test="@product_type = 'product_virtual' or @product_type = 'virtual'">
									<iaixsl:attribute name="class">add_to_basket --virtual</iaixsl:attribute>
								</iaixsl:if>
								...
								<div class="add_to_basket__number_wrapper">
									<select class="add_to_basket__number f-select" tabindex="-1">
										...
										<option>
											<iaixsl:attribute name="value"><iaixsl:value-of select="1 * sizes/@unit_sellby"/></iaixsl:attribute>
											<iaixsl:value-of select="1 * sizes/@unit_sellby"/>
										</option>
										<option>
											<iaixsl:attribute name="value"><iaixsl:value-of select="2 * sizes/@unit_sellby"/></iaixsl:attribute>
											<iaixsl:value-of select="2 * sizes/@unit_sellby"/>
										</option>
										<option>
											<iaixsl:attribute name="value"><iaixsl:value-of select="3 * sizes/@unit_sellby"/></iaixsl:attribute>
											<iaixsl:value-of select="3 * sizes/@unit_sellby"/>
										</option>
										<option>
											<iaixsl:attribute name="value"><iaixsl:value-of select="4 * sizes/@unit_sellby"/></iaixsl:attribute>
											<iaixsl:value-of select="4 * sizes/@unit_sellby"/>
										</option>
										<option>
											<iaixsl:attribute name="value"><iaixsl:value-of select="5 * sizes/@unit_sellby"/></iaixsl:attribute>
											<iaixsl:value-of select="5 * sizes/@unit_sellby"/>
										</option>
										<option>
									...
									<div class="add_to_basket__more">
										<input class="add_to_basket__more_input" name="number" type="number">
											<iaixsl:attribute name="aria-label">Wpisz ilość</iaixsl:attribute>
											<iaixsl:attribute name="value"><iaixsl:value-of select="1 * sizes/@unit_sellby"/></iaixsl:attribute>
											<iaixsl:attribute name="data-id"><iaixsl:value-of select="@id"/></iaixsl:attribute>
											<iaixsl:attribute name="data-prev"><iaixsl:value-of select="1 * sizes/@unit_sellby"/></iaixsl:attribute>
											<iaixsl:attribute name="data-plural"><iaixsl:value-of select="sizes/@unit_plural"/></iaixsl:attribute>
											<iaixsl:attribute name="data-singular"><iaixsl:value-of select="sizes/@unit"/></iaixsl:attribute>
											<iaixsl:attribute name="data-sell-by"><iaixsl:value-of select="sizes/@unit_sellby"/></iaixsl:attribute>
											<iaixsl:attribute name="data-precision"><iaixsl:value-of select="sizes/@unit_precision"/></iaixsl:attribute>
...
<iaixsl:choose>
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1770651171"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1770651171"></script><script src="/gfx/pol/menu_filter.js.gzip?r=1770651171"></script><script src="/gfx/pol/menu_basket.js.gzip?r=1770651171"></script><script src="/gfx/pol/menu_compare.js.gzip?r=1770651171"></script><script src="/gfx/pol/hotspots_javascript.js.gzip?r=1770651171"></script><script src="/gfx/pol/hotspots_slider.js.gzip?r=1770651171"></script><script src="/gfx/pol/hotspots_add_to_basket.js.gzip?r=1770651171"></script><script src="/gfx/pol/search_categoriesdescription.js.gzip?r=1770651171"></script><script src="/gfx/pol/search_paging.js.gzip?r=1770651171"></script><script src="/gfx/pol/search_filters.js.gzip?r=1770651171"></script><script src="/gfx/pol/search.js.gzip?r=1770651171"></script><script src="/gfx/pol/search_categoriesdescription_bottom.js.gzip?r=1770651171"></script><script src="/gfx/pol/search_promo_products.js.gzip?r=1770651171"></script>
