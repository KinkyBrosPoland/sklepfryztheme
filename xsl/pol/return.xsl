							...
							<span class="paymentReturn__header">
								...
								<iaixsl:choose>
									<iaixsl:when test="/shop/page/return/@checkoutType = 'idosell'">
										<img class="smile_icon" alt="Happy smile" src="/gfx/standards/smile_happy_celebrating.svg?r=1770651171"/>
									</iaixsl:when>
									<iaixsl:otherwise>
					...
					<div class="paymentReturn__wrapper --return --error">
						...
						<div id="paymentReturn" class="paymentReturn">
							...
							<span class="paymentReturn__header">
								...
								<iaixsl:choose>
									<iaixsl:when test="/shop/page/return/@checkoutType = 'idosell'">
										<img class="smile_icon" alt="Happy sad" src="/gfx/standards/smile_sad.svg?r=1770651171"/>
									</iaixsl:when>
									<iaixsl:otherwise>
