	...
	<iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
		...
		<head>
				<link rel="stylesheet" type="text/css">
					<iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/css/fontawesome/all.css</iaixsl:attribute>
				</link>
			...
			<iaixsl:choose>
				...
				<link rel="preconnect" href="https://fonts.gstatic.com">
					<iaixsl:attribute name="crossorigin">anonymous</iaixsl:attribute>
				</link>
				<link rel="stylesheet">
					<iaixsl:attribute name="href">https://fonts.googleapis.com/css2?family=Inter:wght@400&#59;500&#59;600&#59;700&#59;800&amp;display=swap</iaixsl:attribute>
				</link>
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/main_style.css?r=1770651171</iaixsl:attribute></link></iaixsl:when>
    <iaixsl:otherwise><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/main_style.css.gzip?r=1770651171</iaixsl:attribute></link></iaixsl:otherwise>
</iaixsl:choose>
...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/main_shop.js?r=1770651171</iaixsl:attribute></script></iaixsl:when>
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/main_shop.js.gzip?r=1770651171</iaixsl:attribute></script></iaixsl:otherwise>
</iaixsl:choose>
...
<!-- (menu_delivery_cost, 60dd8f2ee8f533.38237884.8)-->
  ...
  (function () {
    try {
      var key = 'idosell_freeShippingClosed_v1';
      var html = document.documentElement;
      var bar = document.getElementById('freeShipping');
      if (!bar) return;

      if (localStorage.getItem(key) === '1') {
        html.classList.add('--freeShippingClosed');
        return;
      }

      var closeBtn = bar.querySelector('.freeShipping__close');
      if (!closeBtn) return;
...
<!-- header quick links (custom) -->
<nav class="sf_top_quicknav header_quicklinks d-none d-lg-flex" aria-label="Menu skrótów">
	<a class="header_quicklinks__item" href="/promotions.php">Promocje</a>
	<a class="header_quicklinks__item" href="/producers.php">Marki</a>
	<a class="header_quicklinks__item" href="/text.php?id=XXXX">Poradniki</a>
	<a class="header_quicklinks__item" href="/contact.php">Kontakt</a>
</nav>
...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (main_banner1, 697bbe782a2b21.31486329.2)--><div class="heroSliderModule">
<section class="heroSlider" aria-label="Promocje">
			...
			<script src="https://sklepfryz.pl/data/include/cms/skrypty/main/hero-slider.js" defer="defer"/>
			<script src="https://sklepfryz.pl/data/include/cms/skrypty/main/home-brands-autoscroll.js" defer="defer"/>
			</div><!-- (main_cms2, 697c1f81adc215.43420303.2)--><div>
			
			<section class="homeCats" aria-label="Kategorie">
				<div class="homeCats__wrap variable-max-width">
					<div class="homeCats__list" role="list">
						<a class="homeCats__item" href="/pl/menu/koloryzacja-121.html" role="listitem">
							<span class="homeCats__img">
								<img loading="lazy" src="https://sklepfryz.pl/data/include/cms/homecats/farbowanie.webp" alt="Farbowanie włosów"/>
							</span>
							<span class="homeCats__title">Do farbowania</span>
							<span class="homeCats__cta">SPRAWDŹ!</span>
						</a>
						
						<a class="homeCats__item" href="/pl/menu/paznokcie-115.html" role="listitem">
							<span class="homeCats__img">
								<img loading="lazy" src="https://sklepfryz.pl/data/include/cms/homecats/paznokcie.webp" alt="Stylizacja paznokci"/>
							</span>
							<span class="homeCats__title">Do paznokci</span>
							<span class="homeCats__cta">SPRAWDŹ!</span>
						</a>
						
						<a class="homeCats__item" href="/pl/menu/pielegnacja/wlosy-100.html" role="listitem">
							<span class="homeCats__img">
								<img loading="lazy" src="https://sklepfryz.pl/data/include/cms/homecats/kosmetyki.webp" alt="Kosmetyki do włosów"/>
							</span>
							<span class="homeCats__title">Kosmetyki</span>
							<span class="homeCats__cta">SPRAWDŹ!</span>
						</a>
						
						<a class="homeCats__item" href="/pl/menu/sprzet-102.html" role="listitem">
							<span class="homeCats__img">
								<img loading="lazy" src="https://sklepfryz.pl/data/include/cms/homecats/sprzet.webp" alt="Sprzęt i narzędzia"/>
							</span>
							<span class="homeCats__title">Sprzęt i narzędzia</span>
							<span class="homeCats__cta">SPRAWDŹ!</span>
						</a>
						
						<a class="homeCats__item" href="/pl/menu/dla-mezczyzn-105.html" role="listitem">
							<span class="homeCats__img">
								<img loading="lazy" src="https://sklepfryz.pl/data/include/cms/homecats/meskie.webp" alt="Męskie włosy i zarost"/>
							</span>
							<span class="homeCats__title">Dla mężczyzn</span>
							<span class="homeCats__cta">SPRAWDŹ!</span>
						</a>
						
						<a class="homeCats__item" href="/pl/menu/promocje-110.html" role="listitem">
							<span class="homeCats__img">
								<img loading="lazy" src="https://sklepfryz.pl/data/include/cms/homecats/promocje.webp" alt="Promocje i zestawy"/>
							</span>
							<span class="homeCats__title">Promocje i zestawy</span>
							<span class="homeCats__cta">SPRAWDŹ!</span>
						</a>
					</div>
				</div>
			</section></div><!-- (main_banner3, 697c21228e2e33.01664055.2)-->	<div><section class="homeBrands" aria-label="Karuzela marek" data-brands-json="https://sklepfryz.pl/data/include/cms/skrypty/main/brands.json" data-autoscroll-speed="35" data-step-items="2">
				
				<div class="homeBrands__head">
					<h2 class="homeBrands__title">Jesteśmy autoryzowanym dystrybutorem marek, które znasz z najlepszych salonów:</h2>
				</div>
				
				<div class="homeBrands__wrap">
					<button type="button" class="homeBrands__nav homeBrands__nav--prev" aria-label="Poprzednie marki">
						<span class="homeBrands__chev" aria-hidden="true">❮</span>
					</button>
					
					<div class="homeBrands__track" tabindex="0" aria-label="Lista marek do przewijania">
						
					</div>
					
					<button type="button" class="homeBrands__nav homeBrands__nav--next" aria-label="Następne marki">
						<span class="homeBrands__chev" aria-hidden="true">❯</span>
					</button>
				</div>
				
				<script src="https://sklepfryz.pl/data/include/cms/skrypty/main/home-brands.js" defer="defer"/>
			</section></div><!-- (main_hotspot_zone1, 665eb8cce92d49.67540113.6)-->
  <iaixsl:if test="page/hotspot/products_zone1">
	<script>
		<iaixsl:attribute name="src">https://sklepfryz.pl/data/include/cms/skrypty/main/hotspot-points.js</iaixsl:attribute>
		<iaixsl:attribute name="defer">defer</iaixsl:attribute>
	</script>
							<script>
								<iaixsl:attribute name="src">https://sklepfryz.pl/data/include/cms/skrypty/main/hotspot-tabs.js</iaixsl:attribute>
		<iaixsl:attribute name="defer">defer</iaixsl:attribute>
							</script>
							<iaixsl:if test="page/hotspot/products_zone1 and page/hotspot/products_zone2">
								<div class="hotspot_tabs_header">
									<div class="hotspot_tabs" role="tablist" aria-label="Wybór karuzeli produktów">
										
										<button class="hotspot_tab is-active" type="button"
											data-target="#main_hotspot_zone2"
											data-subhead="Odkryj premiery, na które warto było czekać!"
											role="tab" aria-selected="true" aria-controls="main_hotspot_zone2">
											Nowości <span class="tab_icon" aria-hidden="true"></span>
										</button>
										
										<button class="hotspot_tab" type="button"
											data-target="#main_hotspot_zone1"
											data-subhead="Starannie wybrane propozycje. To może Ci się spodobać!"
											role="tab" aria-selected="false" aria-controls="main_hotspot_zone1">
											Dla Ciebie <span class="tab_icon" aria-hidden="true"></span>
										</button>
										
									</div>
								</div>
								
								<div class="hotspot_tabs_subhead" aria-live="polite">
									Premiery, na które warto było czekać
								</div>
								
								<!-- Link tylko dla Nowości (przeniesiony POD subhead) -->
								<a class="hotspot_tabs_more" href="https://sklepfryz.pl/pl/newproducts/" data-more-for="#main_hotspot_zone2">
									Zobacz wszystko <i class="icon icon-ds-arrow-right pl-1"/>
								</a>
							</iaixsl:if>
							<section id="main_hotspot_zone1" class="hotspot__wrapper hotspot_panel" data-panel="zone1" hidden="hidden">
...
<template class="hotspot_product">
									<div class="product hotspot__product swiper-slide d-flex flex-column">
										...
										<a class="product__icon d-flex justify-content-center align-items-center" tabindex="-1">
											<span class="price_percent --hidden"/>
										</a>
										
										<div class="product__content_wrapper">
											<div class="product__prices mb-auto --omnibus">
											...
											<!-- Punkty przeniesione poza .product__prices (będą pod przyciskiem) -->
											<span class="price --points --hidden"/>
											
											<!-- add_to_basket jest dokładany osobnym template/JS, zostawiamy to bez zmian -->
										</div>
									</div>
								</template>
  ...
  <form class="add_to_basket" action="/basketchange.php" type="post">
    ...
    <div class="add_to_basket__number_wrapper">
			<select class="add_to_basket__number f-select" tabindex="-1">
				...
				<option>
					<iaixsl:attribute name="value"><iaixsl:value-of select="1"/></iaixsl:attribute>
					<iaixsl:value-of select="1"/>
				</option>
				<option>
					<iaixsl:attribute name="value"><iaixsl:value-of select="2"/></iaixsl:attribute>
					<iaixsl:value-of select="2"/>
				</option>
				<option>
					<iaixsl:attribute name="value"><iaixsl:value-of select="3"/></iaixsl:attribute>
					<iaixsl:value-of select="3"/>
				</option>
				<option>
					<iaixsl:attribute name="value"><iaixsl:value-of select="4"/></iaixsl:attribute>
					<iaixsl:value-of select="4"/>
				</option>
				<option>
					<iaixsl:attribute name="value"><iaixsl:value-of select="5"/></iaixsl:attribute>
					<iaixsl:value-of select="5"/>
				</option>
				<option>
      ...
      <div class="add_to_basket__more">
        <input class="add_to_basket__more_input" name="number" type="number" value="1">
          <iaixsl:attribute name="aria-label">Wpisz ilość</iaixsl:attribute>
        </input>
      </div>
    </div>
    <button class="btn --solid --medium add_to_basket__button">
      <iaixsl:attribute name="data-success">Dodany</iaixsl:attribute>
      <iaixsl:attribute name="data-error">Wystąpił błąd</iaixsl:attribute>
      <iaixsl:attribute name="data-text">Do koszyka</iaixsl:attribute>
...
<template class="hotspot_add_to_basket_link">
  <a class="btn --solid --medium add_to_basket__link" tabindex="-1">
    <iaixsl:attribute name="title">Wybierz warian</iaixsl:attribute>
										Wybierz warian
  </a>
</template>
	    </section>
...
<!-- (main_hotspot_zone2, 665eb96390b844.46425110.6)-->
  <iaixsl:if test="page/hotspot/products_zone2">
							<section id="main_hotspot_zone2" class="hotspot__wrapper hotspot_panel" data-panel="zone2">
      <iaixsl:attribute name="data-pageType">main</iaixsl:attribute>
...
<template class="hotspot_add_to_basket_link">
  <a class="btn --solid --medium add_to_basket__link" tabindex="-1">
	...
	<iaixsl:if test="/shop/page/hotspot/products_zone2/@cache_html"> </iaixsl:if>
						...
						<section class="loyalty" id="loyalty_program">
							<div class="loyalty__container">
								<header class="loyalty__header">
									<h2 class="loyalty__title">PRZEPIS NA UDANE ZAKUPY</h2>
									<p class="loyalty__subtitle">z naszym programem punktowym</p>
								</header>
								...
								<div class="loyalty__card">
									<div class="loyalty__steps">
										...
										<div class="loyalty__step">
											<div class="loyalty__icon">
												<img src="https://sklepfryz.pl/data/include/cms//program_lojalnosciowy.svg" alt="Program Lojalnościowy sklepfryz.pl" loading="lazy" />
											</div>
											<h3 class="loyalty__stepTitle">KUPUJESZ</h3>
											<p class="loyalty__stepText">
												Kupuj swoje ulubione produkty tak jak zwykle w naszym sklepie.
											</p>
										</div>
										
										<div class="loyalty__step">
											<div class="loyalty__icon">
												<img src="https://sklepfryz.pl/data/include/cms//Fryz_Punkty.svg" alt="FryzPunkty" loading="lazy" />
											</div>
											<h3 class="loyalty__stepTitle">ZBIERASZ</h3>
											<p class="loyalty__stepText">
												Za każdy produkt biorący udział w akcji otrzymasz punkty po realizacji zamówienia.
											</p>
										</div>
										
										<div class="loyalty__step">
											<div class="loyalty__icon">
												<img src="https://sklepfryz.pl/data/include/cms//Klub_FryzoManiakow.svg" alt="Klub FryzoManiaków i FryzoManiaczek" loading="lazy" />
											</div>
											<h3 class="loyalty__stepTitle">ZYSKUJESZ</h3>
											<p class="loyalty__stepText">
												Dzięki zebranym punktom możesz obniżyć cenę produktu nawet do 0zł!
											</p>
										</div>
									...
									<div class="loyalty__cta">
										<a class="loyalty__button" href="TU_WKLEJ_LINK_DO_STRONY_PROGRAMU">
											POZNAJ SZCZEGÓŁY
										</a>
									</div>
								</div>
...
<!-- (main_news2, 60dd8e807bc210.32067134.6)-->
							...
							<!-- (main_blog, redesigned) -->
							<iaixsl:variable name="main_blog_date">true</iaixsl:variable>
							
							<iaixsl:if test="count(page/mainpage2/item) &gt; 0">
								<section id="main_blog" class="expert_blog">
									<header class="expert_blog__header">
										<h2 class="expert_blog__title">Strefa Ekspercka</h2>
										<p class="expert_blog__subtitle">Sprawdzone porady, inspiracje i nowości ze świata urody</p>
									</header>
									
									<div class="expert_blog__grid">
										<iaixsl:for-each select="page/mainpage2/item">
											<article class="expert_blog__item">
												...
												<iaixsl:choose>
													<iaixsl:when test="image/@src and image/@src != ''">
														<iaixsl:choose>
															<iaixsl:when test="(link/@href) != ''">
																<a class="expert_blog__media" href="{link/@href}" tabindex="-1">
																	<img class="expert_blog__img" src="{image/@src}" width="{image/@width}" height="{image/@height}" loading="lazy">
																		<iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="title/text()"/></iaixsl:attribute>
																	</img>
																</a>
															</iaixsl:when>
															<iaixsl:otherwise>
																<span class="expert_blog__media">
																	<img class="expert_blog__img" src="{image/@src}" width="{image/@width}" height="{image/@height}" loading="lazy">
																		<iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="title/text()"/></iaixsl:attribute>
																	</img>
																</span>
													...
													<iaixsl:otherwise>
														<div class="expert_blog__media --fallback">
															<iaixsl:choose>
																<iaixsl:when test="/shop/mask/top/link/image_mobile/@src and /shop/mask/top/link/image_tablet/@src">
																	<picture>
																		<iaixsl:if test="/shop/mask/top/link/image/@src">
																		...
																		<img class="expert_blog__img" src="{/shop/mask/top/link/image_mobile/@src}" alt="{/shop/mask/top/link/description}" width="{/shop/mask/top/link/image_mobile/@width}" height="{/shop/mask/top/link/image_mobile/@height}" loading="lazy"/>
																	</picture>
																</iaixsl:when>
																<iaixsl:otherwise>
																	<img class="expert_blog__img" src="{/shop/mask/top/link/image/@src}" alt="{/shop/mask/top/link/description}" width="{/shop/mask/top/link/image/@width}" height="{/shop/mask/top/link/image/@height}" loading="lazy"/>
																</iaixsl:otherwise>
															</iaixsl:choose>
														</div>
													</iaixsl:otherwise>
												...
												<!-- CONTENT -->
												<div class="expert_blog__content">
													<iaixsl:if test="$main_blog_date and normalize-space(date) != ''">
														<div class="expert_blog__meta">
															<span class="expert_blog__date"><iaixsl:value-of disable-output-escaping="yes" select="date"/></span>
														</div>
													</iaixsl:if>
													
													<h3 class="expert_blog__name">
														<iaixsl:choose>
															<iaixsl:when test="(link/@href) != ''">
																<a class="expert_blog__nameLink" href="{link/@href}">
															...
															<iaixsl:otherwise>
																<span class="expert_blog__nameLink">
																	<iaixsl:value-of disable-output-escaping="yes" select="title"/>
																</span>
															</iaixsl:otherwise>
														</iaixsl:choose>
													...
													<!-- Kategorie (jeśli system je dostarcza) -->
													<iaixsl:if test="count(categories/category | category | tags/tag | tag) &gt; 0">
														<div class="expert_blog__cats">
															<iaixsl:for-each select="(categories/category | category | tags/tag | tag)[position() &lt;= 3]">
																<span class="expert_blog__cat">
																	<iaixsl:value-of select="."/>
																</span>
															</iaixsl:for-each>
														</div>
													...
													<div class="expert_blog__text">
														<iaixsl:value-of disable-output-escaping="yes" select="description"/>
													</div>
													
													<iaixsl:if test="more/@href">
														<a class="expert_blog__cta" href="{more/@href}">
															DO ARTYKUŁU
															<span class="expert_blog__arrow" aria-hidden="true">→</span>
														</a>
													</iaixsl:if>
												</div>
							...
							<!-- /main_blog -->
<!-- (main_instagram, 61ea6e116c3fd6.95605465.13)-->
	<iaixsl:if test="/shop/integrations/instagram">
		<div id="instagram" class="section instagram --skeleton --main --slider" numberOfElements="{/shop/integrations/instagram/@images_number}">
			...
			<div class="instagram__slider__wrapper">
